          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 19:
                ...
                if (!wallet.deployed) {
                  _data = this._walletFactory.methods.deploy(wallet.salt, to, data, feeToken, feeTo, feeValue, beforeTime, wallet.owner, signature).encodeABI();
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                _data = this._walletFactory.methods.deploy(quickTransaction.salt, quickTransaction.to, quickTransaction.data, quickTransaction.feeToken, from, quickTransaction.feeValue, quickTransaction.beforeTime, quickTransaction.owner, quickTransaction.signature).encodeABI();
                _to = this._walletFactory._address;
                _context2.next = 12;
                break;
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 20:
                ...
                return _context5.abrupt('return', {
                  owner: !wallet.deployed ? wallet.owner : "",
                  salt: !wallet.deployed ? wallet.salt : "",
                  from: wallet.address,
                  to: to,
                  data: data,
                  feeToken: feeToken,
    ...
    value: function _deriveNewKeys(num) {
      for (var i = num; i >= 0; i--) {
        ...
        this._children.push({
          wallet: child,
          owner: owner,
          salt: this._web3.utils.sha3(child.getPublicKey()),
          address: this.buildCreate2Address(this._walletFactory._address, this._web3.utils.sha3(child.getPublicKey()), _Wallet.bytecode + this._web3.eth.abi.encodeParameters(['address'], [owner]).substring(2))
        });
      };
